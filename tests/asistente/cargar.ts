...
export function cargar(...archivos: string[]): Record<string, any> {
  ...
  vm.runInContext(
    `${codigo}
     this.__exp = { esHora, normalizarHora, clasificarItem, yaOcurrio, planDeSincronizacion, formatearCuando, configRazonamiento, modeloDeRespaldo, elegirModeloLiviano, modeloDelIntento, mensajeModeloRetirado, esErrorPasajero, convieneReintentar, normalizarNombre, buscarPersona, formatearPlazo, fechaParaElModelo,
